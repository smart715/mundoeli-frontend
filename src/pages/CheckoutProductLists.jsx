...
const CheckoutProductLists = () => {
  ...
  return (
    ...
    <DashboardLayout>
      <PageHeader title="Checkout Products" onBack={() => { window['history'].back() }}
        extra={
      ...
      <Layout>
        <Layout>
          ...
          <ProductCreationModal checkout={true} isModalVisible={isModalVisible} setIsModalVisible={(value) => setIsModalVisible(value)} currentId={currentId} isUpdate={isUpdate} currentItem={currentItem} />
        </Layout>
      </Layout>
    </DashboardLayout>
  );
};
export default CheckoutProductLists;
